...
namespace View {
    ContinueButton::ContinueButton(const Logic::Vector2D<> &position, const Logic::Vector2D<> &size): ImageButton{position, size} {
        sf::Texture texture;
    ...
    ContinueButton::ContinueButton():ImageButton{} {
